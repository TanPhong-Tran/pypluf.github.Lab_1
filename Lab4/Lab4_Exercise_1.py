...
'''
fig, axes = plt.subplots(ncols=7, nrows=9, figsize=(17, len(dataset_pd.columns)/2))
for i, c in zip(axes.flatten(), dataset_pd.columns):
    sns.boxplot(dataset_pd[c], ax = i)
...
'''
Accuracy using KMeans Clustering:  0.6109282422646478
Accuracy using Agglomerative Clustering:  0.4055299539170507
Accuracy using Birch Clustering:  0.37524687294272546
'''
