...
'''
Accuracy using KMeans Clustering:  0.059322033898305086
Accuracy using Agglomerative Clustering:  0.4661016949152542
Accuracy using Birch Clustering:  0.4661016949152542
'''
