...
def main():
   ...
   accuracy_bayes=bayesian_ridge(X_train,y_train,X_test,y_test)
   print("Accuracy of Bayesian Ridge: ",accuracy_bayes)

   accuracy_ARD=ARD(X_train,y_train,X_test,y_test)
   print("Accuracy of ARD: ",accuracy_ARD)
   ...
   Conclusion:
        ...
        Accuracy of Bayesian Ridge: 0.8076923076923077
   '''
